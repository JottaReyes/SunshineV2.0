...
/**
 * Created by jorge.reyes on 01/08/2014.
 */
public class WeatherProvider extends ContentProvider {
    ...
    private static final String sLocationSettingsSelection =
            WeatherContract.LocationEntry.TABLE_NAME + "." +
    ...
    private Cursor getWatherByLocationSetting(Uri uri, String[] projection, String sortOrder){
    ...
    private Cursor getWeatherByLocationSettingWithDay(Uri uri, String[] projection, String sortOrder){
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (sUriMatcher.match(uri)){
            ...
            {
                returnCursor = getWeatherByLocationSettingWithDay(uri, projection, sortOrder);
                break;
            }
            case WEATHER_WITH_LOCATION:
            {
                returnCursor = getWatherByLocationSetting(uri, projection, sortOrder);
                break;
            }
            case WEATHER:
            {
